/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 88c4323cee576a8b80038936a4b28ef6)
// Runtime types generated with workerd@1.20260317.1 2026-03-18 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SessionCoordinator";
	}
	interface Env {
		DB: D1Database;
		AI: Ai;
		...
		MAX_INDEXED_BYTES: "6291456";
		MAX_FILE_BYTES: "204800";
		SESSION_COORDINATOR: DurableObjectNamespace<import("./src/index").SessionCoordinator>;
		INDEX_WORKFLOW: Workflow<Parameters<import("./src/index").RepoIndexWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGIN" | "MAX_INDEXED_FILES" | "MAX_INDEXED_BYTES" | "MAX_FILE_BYTES">> {}
}
